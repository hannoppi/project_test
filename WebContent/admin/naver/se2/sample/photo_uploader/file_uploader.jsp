			...
			if (item.getFieldName().equals("callback")) {
				...
				if (item.getSize() > 0) {
					...
					if (cnt == 0) {
						...
						String filePath = dftFilePath + "admin" + File.separator + "upload" + File.separator + File.separator + "naver" + File.separator + "se2" + File.separator;
						...
						// return3 += "&sFileURL=/admin/upload/naver/se2/" + realFileNm;
						return3 += "&sFileURL=http://localhost:8533/admin/upload/naver/se2/" + realFileNm;
