			...
			<div class="register_area">
				<div class="inner_register">
					...
					<div class="hgroup">
					    ...
					    <p class="descript">정보를 수정할 수 있습니다.</p>
					</div><!-- // hgroup -->
					
					<form name="frm" action="/admin/member/modify.action" method="post">
						<input type="text" name="id" value="<c:out value="${user.id }" />" />
						<input type="text" name="name" value="<c:out value="${user.name }" />" />
							
						<fieldset>
							<legend class="invisible">회원정보 수정</legend>
							...
							<div class="inner_fieldset">
								...
								<div class="inputfield_outer">
									...
									<input type="text" name="quiz" id="quiz" class="inputfield_global" value="<c:out value="${user.quiz }" />" placeholder="직접 입력해주세요." />
								</div><!-- // inputfield_outer -->
								...
								<button type="submit" class="button_global button_join">수정</button>
